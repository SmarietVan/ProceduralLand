...
public class MeshData
{
	...
	private Vector3[] CalculateNormals()
	{
		...
		int boderTriangleCount = borderTriangles.Length / 3;
		for (int i = 0; i < boderTriangleCount; i++)
		{
			int normalTriangleIndex = i * 3;
	...
	void FlatShading()
	{
		...
		Vector2[] flatShadowedUvs = new Vector2[triangles.Length];

		for (int i = 0; i < triangles.Length; i++)
		{
			flatShadedVertices[i] = vertices[triangles[i]];
			flatShadowedUvs[i] = uvs[triangles[i]];
			triangles[i] = i;
		}
